          ...
          keyframes: [
            {
              "--text-opacity": 0,
              "--border-radius": 0,
              "--left-wing-background": "#ff512f",
              "--right-wing-background": "#ff512f",
              duration: 0.11,
            },
            {
              "--left-wing-background": "#dd2476",
              "--right-wing-background": "#dd2476",
              duration: 0.14,
            },
            {
              "--left-body-background": "#ff512f",
              "--right-body-background": "#ff512f",
              duration: 0.25,
              delay: 0.1,
            },
            {
          ...
          <Fade bottom distance={"4rem"}>
            <div className="relative">
              <input
                type="text"
                id="name"
                className="block w-full h-12 sm:h-14 px-4 text-xl sm:text-2xl font-mono outline-none border-2 border-coralred bg-transparent rounded-[0.6rem] transition-all duration-200"
                value={formData.name}
            ...
            <div className="relative mt-14">
              <textarea
                id="message"
                className="block w-full h-auto min-h-[10rem] max-h-[20rem] sm:h-14 py-2 px-4 text-xl sm:text-2xl font-mono outline-none border-2 border-coralred bg-transparent rounded-[0.6rem] transition-all duration-200"
